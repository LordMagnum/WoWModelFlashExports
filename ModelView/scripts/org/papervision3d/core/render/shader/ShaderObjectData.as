package org.papervision3d.core.render.shader
{
   ...
   public class ShaderObjectData
   {
      ...
      private function perturbUVMatrix(param1:Matrix, param2:Triangle3D, param3:Number = 2) : void
      {
         ...
         _loc12_ = _loc12_ - -_loc20_ * _loc32_ * param3;
         _loc13_ = _loc13_ - -_loc21_ * _loc32_ * param3;
         _loc14_ = _loc14_ - -_loc22_ * _loc33_ * param3;
         _loc15_ = _loc15_ - -_loc23_ * _loc33_ * param3;
         _loc16_ = _loc16_ - -_loc24_ * _loc34_ * param3;
         _loc17_ = _loc17_ - -_loc25_ * _loc34_ * param3;
         param1.tx = _loc12_;
         param1.ty = _loc13_;
