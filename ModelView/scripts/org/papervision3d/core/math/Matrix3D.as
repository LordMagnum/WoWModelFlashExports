package org.papervision3d.core.math
{
   ...
   public class Matrix3D
   {
      ...
      public static function multiplyVector4x4(param1:Matrix3D, param2:Number3D) : void
      {
         ...
         param2.y = _loc3_ * param1.n21 + _loc4_ * param1.n22 + _loc5_ * param1.n23 + param1.n24;
         param2.z = _loc3_ * param1.n31 + _loc4_ * param1.n32 + _loc5_ * param1.n33 + param1.n34;
         param2.x = param2.x * _loc6_;
         param2.y = param2.y * _loc6_;
         param2.z = param2.z * _loc6_;
      }
      ...
      public static function normalizeQuaternion(param1:Object) : Object
      {
         ...
         param1.z = param1.z / _loc2_;
         param1.w = param1.w / _loc2_;
         return param1;
      }
      ...
      {
         var _loc1_:String = "";
         _loc1_ = _loc1_ + (int(this.n11 * 1000) / 1000 + "\t\t" + int(this.n12 * 1000) / 1000 + "\t\t" + int(this.n13 * 1000) / 1000 + "\t\t" + int(this.n14 * 1000) / 1000 + "\n");
         _loc1_ = _loc1_ + (int(this.n21 * 1000) / 1000 + "\t\t" + int(this.n22 * 1000) / 1000 + "\t\t" + int(this.n23 * 1000) / 1000 + "\t\t" + int(this.n24 * 1000) / 1000 + "\n");
         _loc1_ = _loc1_ + (int(this.n31 * 1000) / 1000 + "\t\t" + int(this.n32 * 1000) / 1000 + "\t\t" + int(this.n33 * 1000) / 1000 + "\t\t" + int(this.n34 * 1000) / 1000 + "\n");
         _loc1_ = _loc1_ + (int(this.n41 * 1000) / 1000 + "\t\t" + int(this.n42 * 1000) / 1000 + "\t\t" + int(this.n43 * 1000) / 1000 + "\t\t" + int(this.n44 * 1000) / 1000 + "\n");
         return _loc1_;
      }
   }
}
