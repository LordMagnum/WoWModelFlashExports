package org.papervision3d.core.culling
{
   ...
   public class RectangleLineCuller implements ILineCuller
   {
      ...
      public function testLine(param1:Line3D) : Boolean
      {
         ...
         var _loc8_:Number = (this.cullingRectangle.top - _loc7_) / _loc6_;
         if(_loc8_ > this.rectIntersection.left && _loc8_ < this.rectIntersection.right)
         {
            return true;
         }
         _loc8_ = (this.cullingRectangle.bottom - _loc7_) / _loc6_;
         if(_loc8_ > this.rectIntersection.left && _loc8_ < this.rectIntersection.right)
         {
            return true;
         }
         var _loc9_:Number = _loc6_ * this.cullingRectangle.left + _loc7_;
         if(_loc9_ > this.rectIntersection.top && _loc9_ < this.rectIntersection.bottom)
         {
            return true;
         }
         _loc9_ = _loc6_ * this.cullingRectangle.right + _loc7_;
         if(_loc9_ > this.rectIntersection.top && _loc9_ < this.rectIntersection.bottom)
         {
            return true;
         }
