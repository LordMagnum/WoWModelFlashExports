   ...
   public class BitmapMaterial extends TriangleMaterial implements ITriangleDrawer
   {
      ...
      public function transformUV(param1:Triangle3D) : Matrix
      {
         ...
         else if(bitmap)
         {
            ...
            {
               _loc5_ = _loc5_ - (_loc5_ > 0.05?0.05:-0.05);
               _loc6_ = _loc6_ - (_loc6_ > 0.07?0.07:-0.07);
            }
            if(_loc9_ == _loc7_ && _loc10_ == _loc8_)
            {
               _loc9_ = _loc9_ - (_loc9_ > 0.05?0.04:-0.04);
               _loc10_ = _loc10_ - (_loc10_ > 0.06?0.06:-0.06);
            }
            ...
            _loc15_.invert();
            _loc16_ = this.uvMatrices[param1] = _loc15_.clone();
            _loc16_.a = _loc15_.a;
            _loc16_.b = _loc15_.b;
            _loc16_.c = _loc15_.c;
            _loc16_.d = _loc15_.d;
      ...
      public function transformUVRT(param1:RenderTriangle) : Matrix
      {
         ...
         if(bitmap)
         {
            ...
            {
               _loc4_ = _loc4_ - (_loc4_ > 0.05?0.05:-0.05);
               _loc5_ = _loc5_ - (_loc5_ > 0.07?0.07:-0.07);
            }
            if(_loc8_ == _loc6_ && _loc9_ == _loc7_)
            {
               _loc8_ = _loc8_ - (_loc8_ > 0.05?0.04:-0.04);
               _loc9_ = _loc9_ - (_loc9_ > 0.06?0.06:-0.06);
            }
            ...
            _loc14_.invert();
            _loc15_ = this.uvMatrices[param1] = _loc14_.clone();
            _loc15_.a = _loc14_.a;
            _loc15_.b = _loc14_.b;
            _loc15_.c = _loc14_.c;
            _loc15_.d = _loc14_.d;
      ...
      protected function renderRec(param1:Matrix, param2:Vertex3DInstance, param3:Vertex3DInstance, param4:Vertex3DInstance, param5:Number) : void
      {
         ...
         var _loc7_:RenderRecStorage = RenderRecStorage(this.renderRecStorage[int(param5)]);
         ...
         if(this.d2ca == this.dmax)
         {
            ...
            _loc8_.b = _loc8_.b + param1.a;
            _loc8_.d = _loc8_.d + param1.c;
            _loc8_.ty = _loc8_.ty + (param1.tx - 1);
      ...
      protected function correctBitmap(param1:BitmapData) : BitmapData
      {
         ...
         _loc4_ = _loc4_ == uint(_loc4_)?Number(_loc4_):Number(uint(_loc4_) + 1);
         var _loc5_:Number = param1.height / _loc3_;
         _loc5_ = _loc5_ == uint(_loc5_)?Number(_loc5_):Number(uint(_loc5_) + 1);
