package org.papervision3d.objects.primitives
{
   ...
   public class Sphere extends TriangleMesh3D
   {
      ...
      public function Sphere(param1:MaterialObject3D = null, param2:Number = 100, param3:int = 8, param4:int = 6, param5:String = null)
      {
         super(param1,new Array(),new Array(),param5);
